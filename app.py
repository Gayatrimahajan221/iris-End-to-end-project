# import require packsges
import pandas as pd
import pickle
import  streamlit as st
import numpy as np
# create a header for browser
st.set_page_config(page_title='Iris_title="Iris project - Gayatri')

# add a title in browsers body
st.title("Iris End to End Project - Gayatri Mahajan")
...
# add  a button to predict spacies
